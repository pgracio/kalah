...
public class PlayMessageValidator implements Validator {
  ...
  public void validate(Object target, Errors errors) {
    ...
    if (nextMove == null) {
      errors.rejectValue("player", name + " please wait for another Player to join.");
    } else if (!name.equalsIgnoreCase(nextMove.getName())) {
      errors.rejectValue("player", name + " please wait for your turn.");
